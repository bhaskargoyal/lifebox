...
Lifebox.prototype.draw = function(x, y, w, z) {
    ...
    if(this.rectMode === RADIUS) {
        ...
        scribble.scribbleRect( x, y, this.width, this.height, this.roundCorner.topLeft, this.roundCorner.topRight, this.roundCorner.bottomLeft, this.roundCorner.bottomRight);
        // rect(x, y, this.width, this.height, this.roundCorner.topLeft, this.roundCorner.topRight, this.roundCorner.bottomLeft, this.roundCorner.bottomRight);
    }

    // fill the area
    // the x coordinates of the border points of the hachure
    var xCoords = [ x-(this.width/2), x+(this.width/2), x+(this.width/2), x-(this.width/2) ];
    // the y coordinates of the border points of the hachure
    var yCoords = [ y-(this.height/2), y-(this.height/2), y+(this.height/2), y+(this.height/2) ];
